...
public class MovieLandscapePlayerUiController extends AbstractYouTubePlayerListener {
    ...
    public MovieLandscapePlayerUiController(View controlsUi, YouTubePlayer youTubePlayer, YouTubePlayerView youTubePlayerView, String videoId, float currentTime) {
    ...
    private void initViews(View view) {
        ...
        fullScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("PlayerUiController", "Switching to activity: MoviePlayerActivity");

                intent = new Intent(activity, MoviePlayerActivity.class);
    ...
    public void onReady(YouTubePlayer youTubePlayer) {
        ...
        Log.d("MovieLandscapePlayerUiController", "YouTube Player is ready.");
