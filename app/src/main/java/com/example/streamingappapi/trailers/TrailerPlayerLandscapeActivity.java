...
public class TrailerPlayerLandscapeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trailer_player_landscape);
        ...
        YouTubePlayerListener youTubePlayerListener = new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NonNull YouTubePlayer youTubePlayer) {
                ...
                TrailerLandscapePlayerUiController controller = new TrailerLandscapePlayerUiController(controlsUi, youTubePlayer, youTubePlayerView, videoId, currentTime);
